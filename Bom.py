...
def bomb():
 ...
 "    ""#           mmmmm   mmmm          
  mmm   mmmmm   mmm   mmm      #     BOMBER      
 #"  #  # # #  "   #    #      #   PLEASE SUSCRIBE MY CHANNEL        
 #""""  # # #  m"""#    #      #           Aceh Cyber
 "#mm"  # # #  "mm"#  mm#mm    "mm        
*.______________________________________________________________,' (BOM)
...
BOOM GMAIL WORK by ACEH cyber
PLease klik SUSCRIBE my cahnnel 
